...
<form enctype="multipart/form-data" method="post" action="index.php?view=inputprodukinsert" data-ajax="false">
...
?>
		...
		<li class="ui-field-contain">
			...
			<input type="text" name="title" id="title" value="" data-clear-btn="true">
		</li>
		<li class="ui-field-contain">
			<label for="description">Description:</label>
			<textarea cols="40" rows="8" name="description" id="textarea2"></textarea>
		</li>
		<li class="ui-field-contain">
			...
			<div data-role="controlgroup" data-type="horizontal">
				...
				<input name="price" id="currency-controlgroup" type="text" data-wrapper-class="controlgroup-textinput ui-btn">
				<button>,00</button>
			</div>
			...
			<div data-role="controlgroup" data-type="horizontal">
				...
				<input name="priceUS" id="currency-controlgroup" type="text" data-wrapper-class="controlgroup-textinput ui-btn">
				<button>,00</button>
			</div>
		</li>
		<li class="ui-field-contain">
			...
			<div data-role="controlgroup" data-type="horizontal">
				...
				<input name="hpamprice" id="currency-controlgroup" type="text" data-wrapper-class="controlgroup-textinput ui-btn">
				<button>,00</button>
			</div>
			...
			<div data-role="controlgroup" data-type="horizontal">
				...
				<input name="hpampriceUS" id="currency-controlgroup" type="text" data-wrapper-class="controlgroup-textinput ui-btn">
				<button>,00</button>
			</div>
		</li>
		<li class="ui-field-contain">
