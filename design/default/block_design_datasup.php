...
$tableQuery = "
	SELECT * FROM lh_supplier ORDER BY `nama` ASC
	";
...
?>
    <li>
		...
		<h2><?=$data['nama'];?></h2>
		<p>
			<?=$data['alamat'];?>, <?=$data['telp'];?>
			<div>
				<a href="index.php?view=deletesup01&id=<?=$data['id_sup'];?>" class="ui-btn ui-shadow ui-corner-all ui-btn-inline ui-btn-icon-notext ui-shadow-icon ui-btn-a ui-icon-delete">Delete</a>
				<a href="index.php?view=editsup&id=<?=$data['id_sup'];?>" class="ui-btn ui-shadow ui-corner-all ui-btn-inline ui-btn-icon-notext ui-shadow-icon ui-btn-a ui-icon-edit">Edit</a>
			</div>
		</p>
    </li>
<?php
