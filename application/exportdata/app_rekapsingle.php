<a href="#" class="ui-shadow-icon ui-btn ui-shadow ui-corner-all ui-icon-plus ui-btn-icon-left">Rekap Single File</a>
<div class="ui-body ui-body-a ui-corner-all" style="margin-bottom: 10px;">
	<h3>Peringatan !</h3>
	<br /><p>Modul ini hanya digunakan jika kolektor hanya melakukan satu kali DP. Jika lebih dari satu kali DP, data tidak akan valid.</p>
	<br /><p>Untuk memperoleh data yang lebih terperinci dan valid, diperlukan dua buah file yang bisa diperoleh melalui menu <a href="#">Rekap Penjualan</a> dan <a href="#">Rekap Down Payment</a>.</p>
</div>
<form action="application/exportdata/export_excel_single.php" target="_blank" method="post"> 
