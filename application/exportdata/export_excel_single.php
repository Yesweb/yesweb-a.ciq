...
// Mendefinisikan nama file ekspor "rekap_penjualan_artjog[tahun]_singlefile.xls"
header("Content-Disposition: attachment; filename=rekap_penjualan_artjog".$tahun."_singlefile.xls");
...
?>
			<tr>
				...
				<td><?=number_format($data_exp['idr_total_due'], 0, ',', '')?></td>
				<td><?=number_format($data_exp['usd_total_due'], 0, ',', '')?></td>
			</tr>
<?php
